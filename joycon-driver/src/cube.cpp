...
//
//
//MainFrame::MainFrame() : wxFrame(NULL, wxID_ANY, wxT("wxWidgets OpenGL Cube Sample")) {
...
//wxEND_EVENT_TABLE()
//
//MyFrame::MyFrame(bool stereoWindow) : wxFrame(NULL, wxID_ANY, wxT("wxWidgets OpenGL Cube Sample")) {
//	int stereoAttribList[] = { WX_GL_RGBA, WX_GL_DOUBLEBUFFER, WX_GL_STEREO, 0 };
//
//	new TestGLCanvas(this, stereoWindow ? stereoAttribList : NULL);
//
